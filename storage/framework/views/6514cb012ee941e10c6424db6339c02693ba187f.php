<style>
    ...
    .q5{
        ...
        line-height:56.79999923706055px;
    }
    .outer_q5{
        position:relative;
        display:flex;
    ...
    .q7{
        ...
        height:27.46px;
        margin-top:0px;
        margin-bottom:7.539999999999992px;
        min-height:27.46px;
    }
    .outer_q7{
        position:relative;
    ...
    .q12{
        ...
        z-index:11;
        pointer-events:auto;
        transform:rotate(89.91299914645472deg);
        margin-left:73px;
        width:108px;
        min-width:108px;
        margin-top:338px;
        margin-bottom:319.01px;
        min-height:26px;
        text-align:left;
        display:flex;
        flex-direction:column;
    ...
    .q13{
        ...
        z-index:10;
        pointer-events:auto;
        transform:rotate(88.933009957834deg);
        margin-left:335px;
        width:683.12px;
        min-width:683.12px;
        margin-top:-341.01px;
        margin-bottom:341.01px;
        min-height:undefinedpx;
        border:1px solid rgba(71, 85, 92, 1);
    }
    .outer_q13{
        position:relative;
        display:flex;
    ...
    .q14{
        ...
        z-index:3;
        pointer-events:auto;
        transform:rotate(89.82113758303998deg);
        margin-left:502px;
        width:961px;
        min-width:961px;
        margin-top:-612px;
    ...
    .q42{
        ...
        z-index:19;
        pointer-events:auto;
        transform:rotate(-0.11633645379868827deg);
        margin-left:83px;
        width:1003px;
        min-width:1003px;
        margin-top:-131px;
...
@media  screen and (max-width: 1920px) {
    ...
    <html prefix="og: http://ogp.me/ns#" lang="en" dir="ltr" style="height: 100%">
       ...
       <body class="websiteBody">
          ...
          <label for="active" style="postion:fixed;"class="menu-btn">
            <img style="margin-top:100px; width:282px; height:232px; margin-left: 180px; position: absolute;" src="<?php echo e(URL::asset("../images/Ellipse_1.png")); ?>">
            <img style="text-align:center; margin-top:170px; margin-left:260px; position: relative;"src="<?php echo e(URL::asset("../images/menu.png")); ?>">
          </label>
          <div class="wrapper">
             <ul>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <img
                          id="q4"
                          data-name="Ellipse 1"
                          src="<?php echo e(URL::asset("../images/Ellipse_1.png")); ?>"
                          alt="Ellipse 1"
                          class="q4"
                        >
                        </div>
                      ...
                      >
                        ...
                        <img
                          ...
                          src="<?php echo e(URL::asset("../images/First_Class_Conferencing_Facilitation_Logo.png")); ?>"
                      ...
                      >
                        ...
                        <div class="Group-16-outer">
                            ...
                            >
                              ...
                              <img
                                ...
                                alt="Cart"
                                class="Cart"
                                src="<?php echo e(URL::asset("../images/Cart.png")); ?>"
                              >
                              </div>
                        ...
                        <?php if(Cart::count() == 0): ?>
                              <img src="<?php echo e(URL::asset("../images/cartEmpty.jpg")); ?>" width="476px"  height="374px" style="position: relative; top: -50; right: 150;">
                        <?php else: ?>
                        ...
                        <div class="cart-item-group-1-outer">
                            ...
                            >
                              ...
                              <img
                                ...
                                alt="Price"
                                class="Price-3"
                                src="<?php echo e(URL::asset("../images/Price_3.png")); ?>"
                              >
                              </div>
                              ...
                              <img
                                ...
                                alt="delete"
                                class="delete-3"
                                src="<?php echo e(URL::asset("../images/delete_3.png")); ?>"
                              ></a>
                              </div>
                              ...
                              <div
                                ...
                                data-name="$20"
                                class="q-20-3"
                              ><div key="0"><?php echo e($product->price); ?> Points</div>
                              </div>
                              </div>
                            </div>
                            </div>
                    ...
                    <div class="total-and-link-outer">
                      ...
                      >
                        ...
                        <img
                          ...
                          alt="Shopping"
                          class="Shopping"
                          src="<?php echo e(URL::asset("../images/Shopping.png")); ?>"
                        >
                        </div>
                        ...
                        <div
                          ...
                          data-name="$20"
                          class="q-20-4"
                        ><div key="0"><?php echo e(Cart::subtotal('0','','')); ?> Points</div>
                        </div>
                        </div>
                        ...
                        <div class="Arrow-1-outer">
                          <?php if(Cart::count() == 0): ?>
                            <a href="#" style="font-size: 18px; color:rgba(92, 90, 90, 1);">
                              ...
                              alt="Arrow 1"
                              class="Arrow-1"
                              src="<?php echo e(URL::asset("../images/Arrow_1.png")); ?>"
                              ></a>
                          <?php else: ?>
                            <?php if(((float)auth()->user()->points) >= ((float)Cart::subtotal('0','',''))): ?>
                    ...
                    <a href="#">
                        <img
                          id="q44"
                          data-name="WordPress"
                          src="<?php echo e(URL::asset("../images/WordPress.png")); ?>"
                          alt="WordPress"
                          class="q44"
                        ></a>
                        </div>
                    ...
                    <a href="#">
                        <img
                          id="q45"
                          data-name="TikTok"
                          src="<?php echo e(URL::asset("../images/TikTok.png")); ?>"
                          alt="TikTok"
                          class="q45"
                        ></a>
                        </div>
                    ...
                    <a href="https://www.facebook.com/firstclassfacilitation/">
                        <img
                          id="q46"
                          data-name="Facebook"
                          src="<?php echo e(URL::asset("../images/Facebook.png")); ?>"
                          alt="Facebook"
                          class="q46"
                        ></a>
                        </div>
                    ...
                    <a href="https://ca.linkedin.com/company/first-class-facilitation">
                        <img
                          id="q47"
                          data-name="LinkedIn"
                          src="<?php echo e(URL::asset("../images/LinkedIn.png")); ?>"
                          alt="LinkedIn"
                          class="q47"></a>
                        </div>
                        <div class="outer_q48">
                    <a href="https://twitter.com/fccfacilitation?lang=en">
                        <img
                          ...
                          src="<?php echo e(URL::asset("../images/Twitter_Squared.png")); ?>"
                          alt="Twitter Squared"
                          class="q48"
                        ></a>
                        </div>
                    ...
                    <a href="https://www.instagram.com/firstclassfacilitation/">
                        <img
                          id="q49"
                          data-name="Instagram"
                          src="<?php echo e(URL::asset("../images/Instagram.png")); ?>"
                          alt="Instagram"
                          class="q49"
                        ></a>
                        </div>
    ...
    </html><?php /**PATH C:\Users\jjour\FCCF-Market\resources\views/carts/index.blade.php ENDPATH**/ ?>