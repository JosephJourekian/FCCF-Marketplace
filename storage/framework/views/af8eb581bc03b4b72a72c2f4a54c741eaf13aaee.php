...
unset($__errorArgs, $__bag); ?>
          ...
          <div
            ...
            class="q24"
          ><div key="0"><a href="<?php echo e(route('password.request')); ?>" style="white-space: nowrap; font-family:Baskervville;">Forgot Password?</a></div>
          </div>
          </div>
        </div>
        </div>
    ...
    <button type="submit" hidden class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 mr-2">Submit</button>
    </form>
    </body>
  </html><?php /**PATH C:\Users\jjour\FCCF-Market\resources\views/auth/login.blade.php ENDPATH**/ ?>