...
@media  screen and (max-width: 1920px) {
    ...
    .myButton {
        box-shadow: 0px 1px 0px 0px #f0f7fa;
        background:linear-gradient(to bottom, #B5EBFF 5%, #019ad2 100%);
        background-color:#33bdef;
        border-radius:20px;
        border:1px solid #057fd0;
        display:inline-block;
...
.footerRectangle{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="title" style="margin-left: 310px;margin-top: 15px; width:fit-content;">TECH UPDATES</div>
                      ...
                      >
                        ...
                        <div class="Group-16-outer">
                            ...
                            >
                              ...
                              <div
                                ...
                                data-name="items:"
                                class="items-"
                              ><div key="0">Please select the article to read more about recent tech updates.</div>
                              </div>
                              </div>
                            </div>
                            </div>
                        ...
                        <div class="tech">
                            <div class="square">
                                <img src="../images/teams.png" width="130">
                            </div>
                        ...
                        <div class="tech" style="left:300px">
                            <div class="square">
                                <img src="../images/zoom.png" width="200" style="position: relative; top: -32px;">
                            </div>
                            <div class="panel1"></div>
                            <div class="panel2"></div>
                            <div class="panel3"></div>
                        ...
                        <div class="tech" style="left:600px">
                            <div class="square">
                                <img src="../images/slack.png" width="200" style="position: relative; top: -32px;">
                            </div>
                            <div class="panel1"></div>
                            <div class="panel2"></div>
                            <div class="panel3"></div>
    ...
    </html><?php /**PATH C:\Users\jjour\FCCF-Market\resources\views/techUpdates/index.blade.php ENDPATH**/ ?>