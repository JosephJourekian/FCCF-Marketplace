...
<?php $__currentLoopData = $updates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $update): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="border border-gray-800 rounded-lg mb-2">
        ...
        <div class="flex mb-3">
            <p><button class="bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 mr-4 ml-3"><a href="<?php echo e(route('techUpdates.show',$update->techname)); ?>" class="card-link">View Update</a></button>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?><?php /**PATH C:\Users\jjour\FCCF-Market\resources\views/techUpdates/index.blade.php ENDPATH**/ ?>