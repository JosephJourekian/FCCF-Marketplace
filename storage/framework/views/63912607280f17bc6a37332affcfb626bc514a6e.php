...
.footerRectangle{
                  ...
                  >
                    ...
                    >
                      ...
                      <!--Header logo, title and lines -->
                        ...
                        <div class="title" style="margin-left: 320px;margin-top: 15px; width:fit-content;">MY ACCOUNT</div>
                    ...
                    >
                      <div class="outer_q10">
                        <!--Profiles text and the sunset picture -->
                      <div class="Group-16-outer">
                          ...
                          >
                            ...
                            <div
                              ...
                              data-name="items:"
                              class="items-"
                            ><div key="0">You’re in, <?php echo e(auth()->user()->name); ?>! All of your personal info and order history is</div>
                            <div key="1"> saved here for your reference and to manage whenever you need.</div>
                            </div>
                            </div>
                      ...
                      <div class="Wish-List-outer">
                        ...
                        >
                          ...
                          <div
                            id="Want-it--wish-for-it"
                            data-name="Want it, wish for it, wait for it! Save and share your favourite finds"
                            class="Want-it--wish-for-it"
                          ><div key="0">Want it, wish for it, wait for it! </div>
                          <div key="1">Save and share your favourite finds</div>
                          </div>
                          </div>
                          <div class="View-Edit-3-outer">
                          <div
                            id="View-Edit-3"
                            data-name="View/Edit"
                            class="View-Edit-3"
                        ...
                        <div class="OrderHistoryOuter">
                          <div
                            ...
                            class="OrderHistory"
                          >
                            <div class="OrderHistoryListOuter">
                            <div
                              id="OrderHistoryList"
                          ...
                          <div class="PaymentOuter">
                            ...
                            >
                              ...
                              <div
                                ...
                                data-name="OrderHistoryView"
                                class="PaymentView"
                              ><div key="0"><a href="<?php echo e(route('profiles.editPayment',auth()->user()->username)); ?>" style="color:rgba(92, 90, 90, 1);">View/Edit</a></div>
                              </div>
                              </div>
                            </div>
                            </div>
  ...
  </html><?php /**PATH C:\Users\jjour\FCCF-Market\resources\views/profiles/index.blade.php ENDPATH**/ ?>