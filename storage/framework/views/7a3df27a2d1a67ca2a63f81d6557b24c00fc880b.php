...
<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="border border-gray-800 rounded-lg">
        ...
        <?php $__currentLoopData = unserialize($order['cart']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <img class="rounded-lg" src="<?php echo e($item->options->img); ?>" style="width:150px;height:125px;float:left">
            <a class="font-bold text-md" style="color:blue"href="<?php echo e(route('products.show',$item->id)); ?>"><?php echo e($item->name); ?></a>
            <h1 class="font-bold text-md mt-4 block">Quantity: <?php echo e($item->qty); ?></h1>
            <h1 class="font-bold text-md mb-4 block">Price: <?php echo e($item->price); ?> Points</h1>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <h1 class="font-bold text-md mb-4 block">Subtotal of the order: <?php echo e($order->order_subtotal); ?> Points</h1>
    </div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
