...
.footerRectangle{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="title" style="margin-left: 315px;margin-top: 15px; width:fit-content;">FCCF UPDATES</div>
                            ...
                            <div style="display: -webkit-inline-box; left: 333; top: -19; position: relative;">
                                <?php if(auth()->user()->isAdmin()): ?>
                                    <form method="POST" action="<?php echo e(route('fccfUpdates.delete')); ?>"> 
                                        ...
                                        <button type="submit" class="BUTTON_TRE" style="color:rgba(92, 90, 90, 1); text-decoration:none; margin-right:20px;">
                                            Delete
                                        </button>
                                    </form>
                                    <div class="BUTTON_TRE" style="margin-right:20">
                                        <a href="<?php echo e(route('fccfUpdates.edit',$update->updatename)); ?>" style="color:rgba(92, 90, 90, 1);text-decoration:none;">
                                            Edit
                                        </a>
                                    </div>
                                <?php endif; ?>
                                <div class="BUTTON_TRE">
                                    <a href="<?php echo e(route('fccfUpdates.index')); ?>" style="color:rgba(92, 90, 90, 1);text-decoration:none;">
                                        Back to updates
                                    </a>
                                </div>
                            </div>
    ...
    </html><?php /**PATH C:\Users\jjour\FCCF-Market\resources\views/fccfUpdates/show.blade.php ENDPATH**/ ?>