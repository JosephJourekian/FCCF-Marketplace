<style>
    ...
    .q4{
        ...
        font-weight:400;
        font-size:34px;
        line-height:45.60000228881836px;
    }
    .outer_q4{
        position:relative;
        display:flex;
    ...
    .q10{
        ...
        height:100%;
        margin-top:0%;
        border:1px solid rgba(71, 84, 92, 1);
        border-radius:5px;
    }
    .outer_q10{
        position:absolute;
    ...
    .q12{
        ...
        z-index:21;
        pointer-events:auto;
        margin-left:1.7142857142857142%;
    ...
    .q13{
        ...
        width:40.857142857142854%;
        height:22.5%;
        margin-top:13.428571428571429%;
        text-align:left;
        display:flex;
        flex-direction:column;
        justify-content:flex-start;
    ...
    .q19{
        ...
        pointer-events:auto;
        margin-left:5.714285714285714%;
        width:30.857142857142858%;
        height:21.794871794871796%;
        margin-top:12.285714285714286%;
        text-align:left;
        display:flex;
        flex-direction:column;
        justify-content:flex-start;
    ...
    .q23{
        ...
        z-index:8;
        pointer-events:auto;
        margin-left:22.39177309669927%;
        width:77.58334715541544%;
        height:100%;
        margin-top:0%;
        text-align:left;
        display:flex;
    ...
    .q24{
        ...
        z-index:6;
        pointer-events:auto;
        margin-left:68.69565217391305%;
        width:31.304347826086957%;
        height:100%;
        margin-top:0%;
        text-align:left;
        display:flex;
    ...
    <head>
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Covered+By+Your+Grace:400">
          ...
          >
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-1100px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                    data-name="Email bounding box"
                    class="q9"
                  >
                    <div class="outer_q10">
                    <div
                  ...
                  <div
                    id="q12"
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">Full Name</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-1000px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                  ...
                  <div
                    ...
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">Username</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-900px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                  ...
                  <div
                    ...
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">Address</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-800px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                  ...
                  <div
                    ...
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">City</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-700px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                  ...
                  <div
                    ...
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">Postal Code</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-600px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                  ...
                  <div
                    ...
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">Province</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
...
unset($__errorArgs, $__bag); ?></div>
            ...
            <div class="outer_q8">
                <div
                  ...
                  data-name="Email"
                  class="q8"
                  style="margin-bottom: 460px; margin-top:-500px;"
                >
                  <div class="outer_q9">
                  <div
                    id="q9"
                  ...
                  <div
                    ...
                    data-name="Email label"
                    class="q12"
                  ><div key="0" style="white-space: nowrap; ">Phone Number</div>
                  </div>
                  </div>
                  <div class="outer_q13">
                  <div
