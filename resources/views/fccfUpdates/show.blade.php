                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <!--Update contents such as image, date, author, excerpt, body and links -->
                        <div class="article">
                            ...
                            @endforeach
                            <!--Buttons to delete or edit. only admins can see -->
                            <div style="display: -webkit-inline-box; left: 333; top: -19; position: relative;">
                                ...
                                @endif
                                <!--Back to updates index page -->
                                <div class="BUTTON_TRE">
                                    <a href="{{ route('fccfUpdates.index') }}" style="color:rgba(92, 90, 90, 1);text-decoration:none;">
                                        Back to updates
                                    </a>
                                </div>
                            </div>
