                      ...
                      <div class="Group-16-outer">
                          ...
                          >
                            ...
                            <div
                              ...
                              data-name="items:"
                              class="items-"
                            ><div key="0">You’re in, {{ auth()->user()->name }}! All of your personal info and order history is</div>
                      ...
                      <div class="Wish-List-outer">
                        ...
                        <div class="OrderHistoryOuter">
                          ...
                          >
                            ...
                            ><div key="0"><a href="{{route('purchaseHistory',auth()->user()->username) }}" style="color:rgba(92, 90, 90, 1);">View/Edit</a></div>
                            </div>
                            </div>
                          </div>
                          </div>
                            ...
                            <div class="AddressOuter">
                              ...
                              >
                                ...
                                <div
                                  ...
                                  data-name="OrderHistoryView"
                                  class="AddressView"
                                ><div key="0"><a href="{{ route('profiles.editAddress',auth()->user()->username) }}" style="color:rgba(92, 90, 90, 1);">View/Edit</a></div>
                                </div>
                                </div>
                              </div>
                              </div>
