                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="title" style="margin-left: 275px;margin-top: 15px; width:fit-content;">EDIT PAYMENT INFO</div>
                      ...
                      >
                        ...
                        <!--Form to change payment info. The previous info will be posted. All info is encrypted and decrypted only for this page and the checkout page -->
                        <form method="POST" action="{{ route('profiles.updatePayment',auth()->user()->username)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
